...
:::info
If possible, avoid direct access to the network drive with programs that create temporary (\*.temp) files or tend to lock files.  
This can lead to undesirable synchronization behavior.
**This is a known issue and will be fixed in future [improvements](https://filen.io/hub/status-update-june-july-2025/#sync-improvements-desktop-client).**
:::
